...
数据集构造，编码器损伤，标签工具方法，模型特征输入，模型结构，模型输出mos的误差mae/mse，论文引用数

2024 Evaluating Recurrent Neural Networks for prediction of Multi-Variate time series VoIP metrics
1. 研究背景与目标
...
2024 A mean opinion score prediction model for VoIP calls offloading handover from LTE to WiFi
1. 研究背景
...
2023 MiniatureVQNet: A Light-Weight Deep Neural Network for Non-Intrusive Evaluation of VoIP Speech Quality
1. 研究背景与动机
...
2022 MOS prediction by SDN controller and User Equipment to maintain good quality for VoIP over WiFi
1. 研究背景
...
2020 An Effective Machine Learning (ML) Approach to Quality Assessment of Voice Over IP (VoIP) Calls
1. 研究背景
	传统方法：
...
2019 Improved VoLTE QoE Estimation Procedure using Network Performance Metrics
1. 研究背景
	现状问题：
